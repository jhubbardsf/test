<script>
   ...
   <main>
      ...
      <div class="nav">
         <div class="szendvics" on:click={() => {location = "szendvics"}}><p>szendvics</p></div>
         <div class="ital" on:click={() => {}}><p class="active">ital</p></div>
         <div class="pogi" on:click={() => {location = "pogi"}}><p>pogi</p></div>
      </div>
