...
<main>
   ...
   <div in:slide={{x:200, duration: 500}} class="grid-container">
   ...
   {#if navigation == "pogi"}
      <p in:slide={{x:200, duration: 500}} style="display: flex; height: 100vh; width: 100vw; justify-content: center; align-items: center;">pogi</p>
   {/if}
